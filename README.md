...
- Latest stable: `6.0.0`. Use the [immutable tagged documentation](https://github.com/phynics/PositronicKit/blob/6.0.0/README.md) and the semver dependency below for production.
...
```swift
.package(url: "https://github.com/phynics/PositronicKit.git", from: "6.0.0")
```
...
> Release availability: this section documents the current Next channel. It is not part of the stable `6.0.0`
