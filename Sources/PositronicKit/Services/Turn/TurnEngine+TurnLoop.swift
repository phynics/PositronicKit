...
private extension TurnEngine {
    func runOneTurn(
        ...
        do {
            ...
            if let persistenceError = await finishRepositoryTurn(context: context, outcome: .cancelled(reason: "Turn task cancelled.")) {
            ...
            let persistenceError = await finishRepositoryTurn(
                context: context,
