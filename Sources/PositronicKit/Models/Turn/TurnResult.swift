...
///
/// The terminal state always comes from the atomic Thread runtime repository,
...
public struct TurnResult: Sendable, Equatable {
    ...
    public init(turnID: UUID, threadID: UUID, outcome: TurnOutcome, message: Message? = nil) {
        self.turnID = turnID
