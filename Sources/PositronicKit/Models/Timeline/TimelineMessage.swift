...
/// Individual message within a timeline
public struct TimelineMessage: Codable, Identifiable, Sendable {
    public var id: UUID
    ...
    /// Creates a persisted timeline row with ordered multimodal content.
    public init(
        id: UUID = UUID(),
        timelineID: UUID,
        role: Message.MessageRole,
