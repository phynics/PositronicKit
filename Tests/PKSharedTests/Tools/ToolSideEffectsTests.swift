...
/// PKRR-004: `ToolSideEffects` is a public type on `PKShared` with a `.mutating` default.
...
struct ToolSideEffectsTests {
    ...
    private struct UndeclaredTool: PKShared.Tool {
    ...
    private struct NoneTool: PKShared.Tool {
    ...
    private struct ExternalProcessTool: PKShared.Tool {
    ...
    func undeclaredToolDefaultsToMutating() {
        // AC: `ToolSideEffects` is a public type on `PKShared` with a `.mutating` default.
